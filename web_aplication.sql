...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 25 Iul 2018 la 15:53
...
(1, 'Interne', 'Acestea sunt stirile din Romania'),
(2, 'Sport', 'Aici sunt toate stirile sportive'),
(3, 'Gaming', 'Stiri despre jocuri ...'),
(4, 'Externe', 'Stiri din strainatate'),
(12, 'Cultura', 'Toate noutatiile din cultura'),
(13, 'Hardware, NoutÄƒÈ›i', 'MMD lanseazÄƒ monitorul curbat Philips 278E9 cu design de ultimÄƒ generaÈ›ie');

-- --------------------------------------------------------

--
-- Structura de tabel pentru tabelul `category_editors`
--
...
--
-- Salvarea datelor din tabel `category_editors`
--
...
(1, 'Robert', 'Hello World', 'Tuesday 11-12-2018 17:18'),
(5, 'v', 'v', 'Wednesday 07-25-2018 14:24');
...
(36, 'Robert De Niro', '<h1 style=\"margin-left:0px; margin-right:0px; text-align:start\">Robert De Niro, &icirc;n primul sÄƒu film realizat dupÄƒ benzi desenate</h1>\r\n\r\n<div class=\"news tabs-container\" style=\"-webkit-text-stroke-width:0px; background:none; border:0px; clear:both; color:#000000; display:block; font-family:LatoLatinWeb,sans-serif; font-size:13px; font-style:normal; font-variant-caps:normal; font-variant-ligatures:normal; font-weight:400; letter-spacing:normal; orphans:2; overflow:hidden; padding:15px 0px 0px; text-align:start; text-decoration-color:initial; text-decoration-style:initial; text-indent:0px; text-transform:none; white-space:normal; widows:2; word-spacing:0px\">\r\n<p style=\"margin-left:0px; margin-right:0px\">Robert De Niro ar putea sÄƒ aparÄƒ &icirc;n cur&acirc;nd &icirc;n primul sÄƒu film realizat dupÄƒ benzi desenate, producÅ£ia Marvel &quot;Joker&quot;, &icirc;n care Joaquin Phoenix interpreteazÄƒ personajul principal, aratÄƒ The Hollywood Reporter.</p>\r\n\r\n<p style=\"margin-left:0px; margin-right:0px\">&nbsp;</p>\r\n\r\n<div class=\"fb-share-button fb_iframe_widget\" style=\"display:inline-block; padding:0px; position:relative\"><iframe frameborder=\"0\" height=\"1000px\" name=\"f1af1dd69c12bbc\" scrolling=\"no\" src=\"https://www.facebook.com/plugins/share_button.php?app_id=1184214035002977&amp;channel=http%3A%2F%2Fstaticxx.facebook.com%2Fconnect%2Fxd_arbiter%2Fr%2FbSTT5dUx9MY.js%3Fversion%3D42%23cb%3Df2e2d853176a778%26domain%3Dwww.mediafax.ro%26origin%3Dhttp%253A%252F%252Fwww.mediafax.ro%252Ff3da6057e44f3c4%26relation%3Dparent.parent&amp;container_width=560&amp;href=http%3A%2F%2Fwww.mediafax.ro%2Flife-inedit%2Frobert-de-niro-in-primul-sau-film-realizat-dupa-benzi-desenate-17367888&amp;locale=en_US&amp;sdk=joey&amp;type=button\" style=\"border: none; position: absolute; width: 59px; visibility: visible; height: 20px;\" title=\"fb:share_button Facebook Social Plugin\" width=\"1000px\"></iframe></div>\r\n<strong>184 afiÅŸÄƒri</strong>\r\n\r\n<p style=\"margin-left:0px; margin-right:0px\">&nbsp;</p>\r\n\r\n<div class=\"ArticleImageContainer\" style=\"float:none; margin-bottom:15px; margin-left:0px; margin-right:0px; margin-top:0px; overflow:hidden; padding:0px; position:relative; width:560px\"><a href=\"http://www.mediafax.ro/life-inedit/robert-de-niro-in-primul-sau-film-realizat-dupa-benzi-desenate-17367888/foto\" style=\"color: rgb(0, 0, 0); display: block; width: 560px;\" title=\"Galerie foto Robert De Niro, Ã®n primul sÄƒu film realizat dupÄƒ benzi desenate\"><img alt=\"Imaginea articolului Robert De Niro, Ã®n primul sÄƒu film realizat dupÄƒ benzi desenate\" id=\"main_picture\" src=\"http://storage0.dms.mpinteractiv.ro/media/1/1/4728/17367888/1/robert-niro-afp-2.jpg?width=560\" style=\"border:0px; width:560px\" /></a>\r\n\r\n<p>Robert De Niro, &icirc;n primul sÄƒu film realizat dupÄƒ benzi desenate</p>\r\n</div>\r\n\r\n<div id=\"article_text_content\" style=\"padding:0px\">\r\n<p style=\"margin-left:0px; margin-right:0px\">Cunoscutul actor este &icirc;n negocieri pentru un rol &icirc;n pelicula &quot;Joker&quot;, realizatÄƒ de Warner Bros.</p>\r\n\r\n<p style=\"margin-left:0px; margin-right:0px\">Filmul ar urma sÄƒ fie regizat de Todd Phillips, cunoscut pentru seria de succes &quot;Marea mahmurealÄƒ/ The Hangover&quot;. Regizorul a scris ÅŸi scenariul producÅ£iei, alÄƒturi de Scott Silver, recomandat de contribuÅ£iile sale scenaristice la &quot;8 Miles&quot; ÅŸi &quot;The Fighter&quot;.</p>\r\n\r\n<p style=\"margin-left:0px; margin-right:0px\">Personajul lui De Niro ar urma sÄƒ aparÄƒ &icirc;n oraÅŸul Gotham undeva la &icirc;nceputul anilor &#39;80, fiind gazda unui talk show care joacÄƒ un rol important &icirc;n originea lui Joker, interpretat de Joaquin Phoenix.</p>\r\n\r\n<div id=\"videoad\" style=\"background-color:unset !important; padding:0px\">&nbsp;</div>\r\n\r\n<div id=\"pa_1x1_psbk_1532533028968\" style=\"padding:0px; position:relative; text-align:center\">&nbsp;</div>\r\n\r\n<div style=\"clear:both; padding:0px\">&nbsp;</div>\r\n\r\n<div id=\"crt-491989\" style=\"padding:0px\">&nbsp;</div>\r\n\r\n<p style=\"margin-left:0px; margin-right:0px\">Actorul, regizorul ÅŸi producÄƒtorul Robert De Niro este considerat unul dintre cei mai talentaÅ£i ÅŸi mai influenÅ£i cineaÅŸti din toate timpurile. Dublu c&acirc;ÅŸtigÄƒtor al premiului Oscar, pentru rolurile din &quot;NaÅŸul: Partea II&quot; (1975) ÅŸi &quot;Taurul furios/ Raging Bull&quot; (1981), De Niro a fÄƒcut multe alte roluri memorabile, &icirc;n special sub bagheta regizoralÄƒ a lui Martin Scorsese, &icirc;n filme precum &quot;Åžoferul de taxi/ Taxi Driver&quot; (1976), &quot;BÄƒieÅ£i buni/ Goodfellas&quot; (1990), &quot;Promontoriul groazei/ Cape Fear&quot; (1991) ÅŸi &quot;Casino&quot; (1995). El este, de asemenea, unul dintre fondatorii celebrului Festival InternaÅ£ional de Film Tribecca de la New York, &icirc;nfiinÅ£at &icirc;n 2002.</p>\r\n</div>\r\n</div>\r\n', '2018-07-25 17:40:50', 10, 12);
...
(1, 'Albert Anton', '$2y$10$dwwGzVWmzhLnODRNQlh8SeNw17P8Y/cZ9Ku82HIk1NbC4J.4RQspy', 'aa@cm.db', 3),
(2, 'Sorin', '$2y$10$yVIK3wPHiNx2KZ9wpoErce6edtAB3eM0Rg1tlvfLV8gCSRvhfgW5e', 'aa@aa.aa', 2),
(9, 'Carl may', '$2y$10$in0WKgMzm9o8Vi.IeUBsRO9zpVqCTgx/2VYUGjv10ReyEi2XOUlsK', 'cc@cr.ty', 3),
(10, 'Dan Doru', '$2y$10$xvB2KA.QkByQJLwCauWQXOe4nv5G4QDUbfyk8dehgoqkNHTXtkUmi', 'dd@cmk-d.to', 3),
(11, 'Emil Garleanu', '$2y$10$9SO.FM.AS/8Ovlj/6R.Bwu/prSnIed9ep.Rk0e78ONNb0fNDouDZS', 'ee@cmk.db', 2),
(12, 'Ford Mitshubisi', '$2y$10$wrmoqM0eAZisEMBWYDSrIu1zXnj39U4DKlpYOzkX37bdax.vd40IO', 'ff@cmk.io', 3),
(13, 'Jacob Marin', '$2y$10$Ar/1BTS1yHAg0riBWjvV5eT.tw/hJSPGHBGsMPyA.PJ2oLfMnaRn2', 'jj@cm,ro', 1),
(15, 'Gert Gheorghe', '$2y$10$hOhh1ISVcprVWgrrgeDgW.dRkhrVv0WZ4ig44OytGqnhtrEFgVFMO', 'gg@cmk-.it', 1);
...
--
-- Restrictii pentru tabele `category_editors`
--
